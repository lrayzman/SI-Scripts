...
//
// (c)2008-2013  L. Rayzman


//stacksize(64*1024*1024);
clear;		
exec("HSPiceUtilities.sci");                       // Include extraction function
...
inputfile=uigetfile("*.tr*" ,boxTitle="Please choose input CSDF file"); 
...
if wvfrm==0 then
  mme("Invalid waveform selection. Script aborted");
  abort;
end
